                ...
                if (response.isSuccessful()){
                    ...
                    for (BreakingQuotes p : breakingRespuesta){
                        ...
                        if (p.getAuthor().equals("Saul Goodman") || p.getAuthor().equals("Walter White") || p.getAuthor().equals("Jesse Pinkman")) {
                            if(p.getAuthor().equals("Saul Goodman")){breakingFrases.setImagen(imagenUser[1]);}
                            if(p.getAuthor().equals("Walter White")){breakingFrases.setImagen(imagenUser[2]);}
                            if(p.getAuthor().equals("Jesse Pinkman")){breakingFrases.setImagen(imagenUser[3]);}
                        } else {
